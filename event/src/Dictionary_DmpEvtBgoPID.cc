//
// File generated by rootcint at Mon Jan 12 08:19:07 2015
...
void DmpEvtBgoPID::ShowMembers(TMemberInspector &R__insp)
{
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "fLayerE", (void*)&fLayerE);
      R__insp.InspectMember("vector<double>", (void*)&fLayerE, "fLayerE.", false);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "fLayerCS", (void*)&fLayerCS);
      R__insp.InspectMember("vector<short>", (void*)&fLayerCS, "fLayerCS.", false);
...
static void G__setup_memvarDmpEvtBgoPID(void) {
   ...
   G__memvar_setup((void*)((long)(&p->fLayerE)-(long)(p)),117,0,0,G__get_linked_tagnum(&G__Dictionary_DmpEvtBgoPIDLN_vectorlEdoublecOallocatorlEdoublegRsPgR),G__defined_typename("vector<double>"),-1,1,"fLayerE=",0,"Layer Cluster Energy");
   G__memvar_setup((void*)((long)(&p->fLayerCS)-(long)(p)),117,0,0,G__get_linked_tagnum(&G__Dictionary_DmpEvtBgoPIDLN_vectorlEshortcOallocatorlEshortgRsPgR),G__defined_typename("vector<short>"),-1,1,"fLayerCS=",0,"Layer Cluster Size");
